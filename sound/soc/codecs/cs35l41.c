		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		regmap_write(cs35l41->regmap, CS35L41_PWR_CTRL2, 0x3721);
		regmap_write(cs35l41->regmap, CS35L41_AMP_DIG_VOL_CTRL, 0x8000);
		if (component->name_prefix) {
			if (!strcmp(component->name_prefix, "Left")) {
				dev_info(cs35l41->dev, "Applying Jupiter Left patch\n");
				regmap_write(cs35l41->regmap, CS35L41_PWR_CTRL2, 0x3721);
			} else if (!strcmp(component->name_prefix, "Right")) {
				dev_info(cs35l41->dev, "Applying Jupiter Right patch\n");
				regmap_write(cs35l41->regmap, CS35L41_PWR_CTRL2, 0x3301);
			}
		}
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		if (val & CS35L41_GLOBAL_EN_MASK) {
			...
			regmap_write(cs35l41->regmap, CS35L41_PWR_CTRL2, 0);
			regmap_write(cs35l41->regmap, CS35L41_AMP_DIG_VOL_CTRL, 0x8000);
...
#ifdef CONFIG_ACPI
		dev_dbg(cs35l41->dev, "Using default Boost component config\n");
#else
...
static const struct reg_sequence cs35l41_jupiter_left_patch[] = {
	{0x3400,			0x00003200},
	{0x3804,			0x00000002},
	{0x201c,			0x01000110},
	{0x242c,			0x02020000},
...
static const struct reg_sequence cs35l41_jupiter_right_patch[] = {
	{0x3400,			0x00001200},
	{0x3804,			0x00000002},
	{0x201c,			0x01000110},
	{0x242c,			0x02020000},
...
static int cs35l41_component_probe(struct snd_soc_component *component)
{
	...
	if (component->name_prefix) {
		if (!strcmp(component->name_prefix, "Left")) {
			dev_info(cs35l41->dev, "Applying Jupiter Left patch\n");
			regmap_register_patch(cs35l41->regmap, cs35l41_jupiter_left_patch,
									ARRAY_SIZE(cs35l41_jupiter_left_patch));
		} else if (!strcmp(component->name_prefix, "Right")) {
			dev_info(cs35l41->dev, "Applying Jupiter Right patch\n");
			regmap_register_patch(cs35l41->regmap, cs35l41_jupiter_right_patch,
									ARRAY_SIZE(cs35l41_jupiter_right_patch));
		}
	}
