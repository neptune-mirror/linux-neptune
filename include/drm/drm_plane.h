...
struct drm_plane {
	 ...
	 * Format is S31.32 sign-magnitude.
	 */
	struct drm_property *hdr_mult;
	/**
	 * @shaper_lut_property: Optional plane property to set the shaper LUT used
	...
	/**
	 * @shaper_lut_size_property: Optional plane property for the size of the
