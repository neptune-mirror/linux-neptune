...
#define STEAM_CMD_TRIGGER_HAPTIC	0xea
#define STEAM_CMD_TRIGGER_RUMBLE	0xeb
...
{
	int ret;
	u8 report[11] = {STEAM_CMD_TRIGGER_RUMBLE, 9};
	...
	if (enable) {
		...
		if (steam->quirks & STEAM_QUIRK_DECK) {
			steam_write_registers(steam,
				...
				STEAM_REG_LEFT_TRACKPAD_CLICK_PRESSURE, 0xFFFF, /* disable haptic click */
				STEAM_REG_RIGHT_TRACKPAD_CLICK_PRESSURE, 0xFFFF, /* disable haptic click */
